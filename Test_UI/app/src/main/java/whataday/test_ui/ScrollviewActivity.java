...
//            content_layout[i].setBackgroundResource(R.drawable.test2);
            ...
            imageView_background[i].setBackgroundResource(R.drawable.test3);
        ...
        content.getViewTreeObserver().addOnScrollChangedListener(new ViewTreeObserver.OnScrollChangedListener() {
            ...
            public void onScrollChanged() {
                ...
                for(int i=0; i<3; i++){
                    ...
                    int resize_height = convert_int_map(content_height[i], view_width / 2, view_width, bitmap_image.getHeight() / 2, bitmap_image.getHeight());

                    Bitmap crop_bitmap = BitmapUtil.cropCenterBitmap(bitmap_image, bitmap_image.getWidth(), resize_height);
                    Drawable b = new BitmapDrawable(getResources(), crop_bitmap);

                    imageView_background[i].setBackground(b);

                }

                Log.i("FOCUS :", String.valueOf(focus_item));
